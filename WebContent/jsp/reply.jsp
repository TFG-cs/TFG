...
<head>
 <link rel="stylesheet" type="text/css" href="1/styles/font-awesome.css" />
    <link rel="stylesheet" type="text/css" href="1/styles/simditor.css" />

    <script type="text/javascript" src="1/scripts/js/jquery.min.js"></script>
    <script type="text/javascript" src="1/scripts/js/module.js"></script>
    <script type="text/javascript" src="1/scripts/js/uploader.js"></script>
    <script type="text/javascript" src="1/scripts/js/simditor.js"></script>         
...
<body class="clearfix with-menu with-shortcuts" onload="time()">
	...
	<section role="main" id="main" >
		...
		<noscript class="message black-gradient simpler">Your browser does not support JavaScript! Some features won't work as expected...</noscript>
                 ...
                 <div class="columns" style="background-image:url('http://www.cctv.com/history/special/C12260/20041015/images/101363_b.jpg');">
		...
		<div class="with-padding"  >
			...
			<div class="left-column-200px">
				...
				<div class="right-column" style="width:1050px">
					

					<div class="eight-columns twelve-columns-tablet">
					<form name="Form1" method="post" action="/TFG/AddTopicServlet">
					<input type="hidden" id="userid" name="userid" value="3"/>
					<input type="hidden" id="schoolid" name="schoolid" value="1"/>
					 <h3 class="thin">发表新帖</h3>
					  <p> <input id="title" name="title" type="text"  onfocus="if (value =='点此输入标题'){value =''}" onblur="if (value ==''){value='点此输入标题'}" name="headline" id="headline" class="input full-width" value="点此输入标题"></p>
					<p><textarea name="cleditor" id="cleditor">在此输入 <b>您帖子</b> 内容</textarea>     </p>
					 <span> <textarea id="editor" placeholder="这里输入内容" autofocus></textarea>  </span> 
                                    <p>    <button type="submit" class="button full-width" >submitReply</button>   </p> 
					
					<input type="hidden" id="topicid" name="topicid" value=""/>
					<input type="hidden" id="repliedid" name="repliedid" value=""/>
					<input type="hidden" id="floorid" name="floorid" value=""/>
                                       
					
                  <!--     <p><h3 class="thin">回复</h3>
					   <input type="text" readOnly="true"  name="headline" id="headline" class="input full-width" value="回复# ${floorid}楼 "></p>               

					<p><textarea name="cleditor1" id="cleditor1">在此1输入评论</textarea>    </p>
                                    <p>    <button type="button" class="button full-width" onclick="submitReply()">submitReply</button>   </p> --> 
