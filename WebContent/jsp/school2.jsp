...
<c:if test="${empty requestScope.lstTopic }">
	<!-- 跳转到 ShowEmpsServlet拉去数据 -->
	<script>window.location="/TFG/ShowtopicServlet"; </script>
</c:if>
<c:if test="${empty requestScope.lstHotop }">
	<!-- 跳转到 ShowEmpsServlet拉去数据 -->
	<script>window.location="/TFG/ShowHotopServlet"; </script>
</c:if>
			...
			<div class="left-column-200px">
				...
				<div class="right-column">
					...
					<div class="standard-tabs margin-bottom" id="add-tabs">
						...
						<ul class="tabs" hight=50px>
							<li class="active"><a href="#tab-1"><h3>生活</h3></a></li>
							<li><a href="#tab-2"><h3>学习</h3></a></li>
							<li><a href="#tab-3"><h3>报考指南</h3></a></li>
							<li><a href="#tab-4"><h3>发问贴</h3></a></li>
							<li><a href="#tab-5"><h3>发问贴</h3></a></li>
                                                        <li><a href="#tab-6"><h3>发问贴</h3></a></li>
						</ul>
						...
						<div class="tabs-content">
							...
							<div id="tab-1" class="with-padding">
						      ...
						      <c:forEach items="${requestScope.lstTopic }" var="emp">

                                                 <li><a href="inbox.html" title="点击进入">
							
							

								<h4 class="green underline">${emp.topicTitle}</h4>
                                       <span class="ribbon tiny"><span class="ribbon-inner red-gradient">置顶</span></span>
                                                                 <p class="intro">${emp.topicText}</p>

							
							<div class="button-group absolute-right compact show-on-parent-hover">
								<a href="#" class="button icon-down-fat">取消置顶</a>
								...
								<h4 class="green underline">帖子标题</h4>
                                       <span class="ribbon tiny"><span class="ribbon-inner red-gradient">置顶</span></span>
                                                                 <p class="intro">你好美女！帖子内容</p>
							...
							<div class="button-group absolute-right compact show-on-parent-hover">
								<a href="#" class="button icon-up-fat">置顶</a>
								<a href="#" class="button icon-gear with-tooltip" title="Other actions"></a>
								<a href="#" class="button icon-trash with-tooltip confirm" title="Delete"></a>
							</div>
						</li>
	...
	<section id="menu" role="complementary">
		...
		<div id="menu-content">
			...
			<ul class="unstyled-list">
			 <c:forEach items="${requestScope.lstHotop }" var="emp">
				...
				<li>
					...
					<li>
							<a href="#" title="Read message">
								...
								<strong class="blue">${emp.topicTitle}</strong><br>
                                                              
								<strong>${emp.topicText}</strong>
							</a>
						</li>
						<li>
							<a href="#" title="Read message">
